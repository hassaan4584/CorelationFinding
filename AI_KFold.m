% fprintf('\n Reading All Data\n')
% allDataPath='/Volumes/Parhai/Parhai/LUMS/Semester 4 Spring18/Thesis 2/Datasets/AI-KFold/Train/';
% 
...
% % 
% % 
% % [A, OriginalTrainingOrder] = sort(CorrMatrix, 2, 'descend');
